...
function getPendingData() {
    fetch('http://localhost:3000/flight_applications/getPendingData')
        .then(req => req.json())
        .then(res => {
            ...
            <td class="table-action">
                <a href="#"><i class="align-middle accept-plan" data-toggle="tooltip" data-placement="left" title data-original-title="Accept" data-feather="check-circle"></i></a>
                <a href="#"><i class="align-middle pending-plan" data-toggle="tooltip" data-placement="top" title data-original-title="Pending" data-feather="clock"></i></a>
                <a href="#"><i class="align-middle reject-plan" data-toggle="tooltip" data-placement="right" title data-original-title="Reject" data-feather="x"></i></a>
            </td>`
                feather.replace();
            }
        })
...
function getAcceptedData() {
    fetch('http://localhost:3000/flight_applications/getAcceptedData')
        .then(req => req.json())
        .then(res => {
            let colour
            for (accepted_plan of res) {
                ...
                acceptedPlan.innerHTML = `
                    ...
                    <td class="table-action">
                        <a href="#"><i class="align-middle" data-toggle="tooltip" data-placement="right" title data-original-title="Reject" data-feather="x"></i></a>
                    </td>`
                feather.replace();
            }
        })
...
function getRejectedData() {
    fetch('http://localhost:3000/flight_applications/getRejectedData')
        .then(req => req.json())
        .then(res => {
            let colour;
            ...
            for (rejected_plan of res) {
                ...
                rejectedPlan.innerHTML = `
                    ...
                    <td class="table-action">
                        <a href="#"><i class="align-middle" data-toggle="tooltip" data-placement="left" title data-original-title="Accept" data-feather="check-circle"></i></a>
                    </td>`
                feather.replace();
            }
        })
